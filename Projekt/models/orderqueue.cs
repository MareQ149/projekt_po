...
public class OrderQueue
{
    ...
    public void DisplayQueue()
    {
        ...
        {
            Console.WriteLine($"Numer zamówienia: {item.id}, Nazwa zamówienia: {item.orderName}, Przewidywany czas zamówienia: {item.OrderDeliveryExpected}, Status: {item.status}, Cena: {item.orderPrice}");
        }
    }
}